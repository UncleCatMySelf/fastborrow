            ...
            <div id="page-content-wrapper">
                <div class="container-fluid">
                    <div class="row clearfix">
                        ...
                        <div class="col-md-12 column">
                            <form role="form" class="form-horizontal" action="/fastborrow/admin/collection/search">
                ...
                <#--分页-->
                    <div class="col-md-12 column">
                        ...
                        <#else>
                            <li><a href="/fastborrow/admin/collection/search?page=${currentPage - 1}&size=${size}&userId=${userId}">上一页</a></li>
                        </#if>
                        ...
                        <#list 1..collectionPage.getTotalPages() as index>
                            ...
                            <#else>
                                <li><a href="/fastborrow/admin/collection/search?page=${index}&size=${size}&userId=${userId}">${index}</a></li>
                            </#if>
                        </#list>
                        <#if currentPage gte collectionPage.getTotalPages()>
                            <li class="disabled"><a href="#">下一页</a></li>
                        <#else>
                            <li><a href="/fastborrow/admin/collection/search?page=${currentPage + 1}&size=${size}&userId=${userId}">下一页</a></li>
                        </#if>
                        </ul>
                    </div>
                </div>
