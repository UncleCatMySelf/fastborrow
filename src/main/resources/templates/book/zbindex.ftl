    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <div class="row clearfix">
                ...
                <div class="col-md-12 column">
                    <form role="form" class="form-horizontal" action="/fastborrow/admin/bookmessage/zb_search">
                ...
                <div class="col-md-12 column">
                    <table class="table table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/fastborrow/admin/bookmessage/zb_add?mobookId=${bookMessage.mobookId}">设为主编推荐</a>
                            </td>
                        </tr>
                        </#list>
                        </tbody>
            ...
            <div class="col-md-12 column">
                ...
                <#else>
                    <li><a href="/fastborrow/admin/bookmessage/zb_search?page=${currentPage - 1}&size=${size}&mobookId=${sMobookId}&bookName=${sBookName}">上一页</a></li>
                </#if>
                ...
                <#list 1..bookMessagePage.getTotalPages() as index>
                    ...
                    <#else>
                        <li><a href="/fastborrow/admin/bookmessage/zb_search?page=${index}&size=${size}&mobookId=${sMobookId}&bookName=${sBookName}">${index}</a></li>
                    </#if>
                </#list>
                <#if currentPage gte bookMessagePage.getTotalPages()>
                    <li class="disabled"><a href="#">下一页</a></li>
                <#else>
                    <li><a href="/fastborrow/admin/bookmessage/zb_search?page=${currentPage + 1}&size=${size}&mobookId=${sMobookId}&bookName=${sBookName}">下一页</a></li>
                </#if>
                </ul>
            </div>
            </div>
